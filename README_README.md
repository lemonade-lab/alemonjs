...
export default class plugin {
  ...
  /*
   调用示例   this.reply(e,'我私聊了你噢')
  */

  /**
   * 专用于在频道中转为私聊回复
   */
  reply = async (e: any, content: any) => {
    if (e.isGroup) return false
    const postSessionRes: any = await client.directMessageApi.createDirectMessage({
    ...
    client.directMessageApi.postDirectMessage(guild_id, {
      content
    }).catch(err => {
