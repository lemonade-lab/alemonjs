 ...
 * @returns
 */
export function findAllCurrentValues<M extends Model>(
  this: ModelStatic<M>,
  options: FindOptions<Attributes<M>> = {}
): Promise<Attributes<M>[]> {
  return this.findAll({
 ...
 * @returns
 */
export function findOneCurrentValue<M extends Model>(
  this: ModelStatic<M>,
  options: FindOptions<Attributes<M>> = {}
): Promise<Attributes<M>> {
  return this.findOne({
...
export function findOrCreateValue<M extends Model>(
  this: ModelStatic<M>,
  options: FindOptions<Attributes<M>> = {}
): Promise<[Attributes<M>, boolean]> {
