 ...
 * @returns
 */
function updateConfig(action, key, value = []) {
  let config = {}
...
const showHelp = () => {
  ...
  loginTitle('alemonc Actions')
  console.log('[action] [key] ...[values]')
  console.log('add      key   value1 value2 ...')
  console.log('remove   key   value1 value2 ...')
  console.log('set      key   value')
  console.log('del      key')
  console.log('get      key')
  loginTitle('alemonc Help')
  console.log('help')
  console.log('-h')
}
...
if (args.length > 0) {
  ...
  if (action == 'help' || action == '-h') {
    showHelp()
  } else if (['add', 'remove', 'set', 'del', 'get'].includes(action) && action && key) {
    updateConfig(action, key, values)
  } else {
    showHelp()
  }
}
